...
class Clientes(models.Model):
    ...
    vc_codTipoDocumento = models.ForeignKey('GeneralDetalle', db_column='vc_codTipoDocumento',
    ...
    b_flaginactivo = models.TextField(db_column='b_flagInactivo', blank=True,
    ...
    vc_usuarioedita = models.CharField(db_column='vc_usuarioEdita', max_length=50, blank=True,
...
class Colaborador(models.Model):
    ...
    vc_codigocolaborador = models.CharField(db_column='vc_codigoColaborador', max_length=3, blank=True,
                                            null=True)  # Field name made lowercase.
    vc_codcondicion = models.CharField(db_column='vc_codCondicion', max_length=3, blank=True,
                                       null=True)  # Field name made lowercase.
    vc_codtipotrabajador = models.CharField(db_column='vc_codTipoTrabajador', max_length=3, blank=True,
                                            null=True)  # Field name made lowercase.
    bl_fldiscapasitado = models.TextField(db_column='bl_flDiscapasitado', blank=True,
                                          null=True)  # Field name made lowercase. This field type is a guess.
    ...
    vc_apePatColaborador = models.CharField(db_column='vc_apePatColaborador',
                                            max_length=50)  # Field name made lowercase.
    vc_apematcolaborador = models.CharField(db_column='vc_apeMatColaborador',
                                            max_length=50)  # Field name made lowercase.
    id_ubigeo = models.ForeignKey('Ubigeo', db_column='id_ubigeo', blank=True, null=True, on_delete=False)
    vc_direccioncolaborador = models.CharField(db_column='vc_direccionColaborador', max_length=150, blank=True,
                                               null=True)  # Field name made lowercase.
    vc_correopersonal = models.CharField(db_column='vc_correoPersonal', max_length=100, blank=True,
                                         null=True)  # Field name made lowercase.
    vc_correocorporativo = models.CharField(db_column='vc_correoCorporativo', max_length=100, blank=True,
                                            null=True)  # Field name made lowercase.
    dt_fecnacimiento = models.DateField(db_column='dt_fecNacimiento', blank=True,
                                        null=True)  # Field name made lowercase.
    ...
    vc_telfcolaborador = models.CharField(db_column='vc_telfColaborador', max_length=10, blank=True,
                                          null=True)  # Field name made lowercase.
    vc_codestado = models.CharField(db_column='vc_codEstado', max_length=3)  # Field name made lowercase.
    b_flaginactivo = models.TextField(db_column='b_flagInactivo', blank=True,
                                      null=True)  # Field name made lowercase. This field type is a guess.
...
class ColaboradoresCargo(models.Model):
    id_colaboradoresCargo = models.AutoField(db_column='id_colaboradoresCargo',
                                             primary_key=True)  # Field name made lowercase.
    id_colaborador = models.ForeignKey(Colaborador, db_column='id_colaborador', on_delete=False)
    vc_codCargo = models.ForeignKey('GeneralDetalle', db_column='vc_codCargo',
                                    on_delete=False)  # Field name made lowercase.
    b_flagInactivo = models.TextField(db_column='b_flagInactivo', blank=True,
                                      null=True)  # Field name made lowercase. This field type is a guess.
    dt_crea = models.DateTimeField()
...
class GeneralDetalle(models.Model):
    ...
    id_general = models.ForeignKey(General, db_column='id_general', on_delete=False)
...
class IngresoCabecera(models.Model):
    id_ingresoCabecera = models.AutoField(db_column='id_ingresoCabecera',
                                          primary_key=True)  # Field name made lowercase.
    vc_ocRayro = models.CharField(db_column='vc_ocRayro', max_length=10, blank=True,
                                  null=True)  # Field name made lowercase.
    vc_codRepcion = models.ForeignKey('GeneralDetalle', db_column='vc_codRepcion', related_name='vc_codRepcion',
                                      on_delete=False)  # Field name made lowercase.
    id_proyecto = models.ForeignKey('Proyectos', db_column='id_proyecto', related_name='proyectos', on_delete=False)
    vc_codEstado = models.ForeignKey('GeneralDetalle', db_column='vc_codEstado', related_name='vc_codEstado',
                                     on_delete=False)  # Field name made lowercase.
    dt_emision = models.DateField()
    id_proveedor = models.ForeignKey('Proveedor', db_column='id_proveedor', on_delete=False)
    vc_codTipoComprobante = models.ForeignKey('GeneralDetalle', db_column='vc_codTipoComprobante',
                                              related_name='vc_codTopoComprobante',
                                              on_delete=False)  # Field name made lowercase.
    ...
    vc_codCondicionPago = models.ForeignKey('GeneralDetalle', db_column='vc_codCondicionPago',
                                            related_name='vc_codCondicionPago',
                                            on_delete=False)  # Field name made lowercase.
    ...
    b_flagInactivo = models.BooleanField(
        db_column='b_flagInactivo')  # Field name made lowercase. This field type is a guess.
    dt_crea = models.DateTimeField()
    vc_usuarioCrea = models.CharField(db_column='vc_usuarioCrea', max_length=50)  # Field name made lowercase.
    vc_ipCrea = models.CharField(db_column='vc_ipCrea', max_length=20)  # Field name made lowercase.
    dt_edita = models.DateTimeField(blank=True, null=True)
...
class IngresoConformidad(models.Model):
    id_ingresoConformidad = models.AutoField(db_column='id_ingresoConformidad',
                                             primary_key=True)  # Field name made lowercase.
    id_ingresoCabecera = models.ForeignKey(IngresoCabecera, db_column='id_ingresoCabecera',
                                           on_delete=False)  # Field name made lowercase.
    fl_importeConformidad = models.DecimalField(db_column='fl_importeConformidad', max_digits=9,
                                                decimal_places=2)  # Field name made lowercase.
    tx_observacionConformidad = models.TextField(db_column='tx_observacionConformidad', blank=True,
                                                 null=True)  # Field name made lowercase.
    dt_fecConformidad = models.DateTimeField(db_column='dt_fecConformidad')  # Field name made lowercase.
    vc_codConformidad = models.ForeignKey(GeneralDetalle, db_column='vc_codConformidad',
                                          on_delete=False)  # Field name made lowercase.
    b_flagInactivo = models.BooleanField(
        db_column='b_flagInactivo')  # Field name made lowercase. This field type is a guess.
    dt_crea = models.DateTimeField()
    ...
    vc_usuarioEdita = models.CharField(db_column='vc_usuarioEdita', max_length=50, blank=True,
                                       null=True)  # Field name made lowercase.
    vc_ipeEita = models.CharField(db_column='vc_ipEdita', max_length=20, blank=True,
                                  null=True)  # Field name made lowercase.
...
class IngresoDetalle(models.Model):
    ...
    id_ingresoCabecera = models.ForeignKey(IngresoCabecera, db_column='id_ingresoCabecera',
                                           on_delete=False)  # Field name made lowercase.
    vc_codDireccionGasto = models.ForeignKey(GeneralDetalle, db_column='vc_codDireccionGasto',
                                             on_delete=False)  # Field name made lowercase.
    id_materiales = models.ForeignKey('Materiales', db_column='id_materiales', on_delete=False)
    nu_cantidad = models.DecimalField(max_digits=9, decimal_places=2)
    nu_totalIngreso = models.DecimalField(db_column='nu_totalIngreso', max_digits=9,
                                          decimal_places=2)  # Field name made lowercase.
    nu_precioUnitario = models.DecimalField(db_column='nu_precioUnitario', max_digits=9,
                                            decimal_places=2)  # Field name made lowercase.
    nu_Importe = models.DecimalField(db_column='nu_Importe', max_digits=9,
                                     decimal_places=2)  # Field name made lowercase.
    ...
    bl_conformidadOC = models.BooleanField(
        db_column='bl_conformidadOC')  # Field name made lowercase. This field type is a guess.
    bl_conformidadAdm = models.BooleanField(
        db_column='bl_conformidadAdm')  # Field name made lowercase. This field type is a guess.
    b_flagInactivo = models.BooleanField(
        db_column='b_flagInactivo')  # Field name made lowercase. This field type is a guess.
    dt_crea = models.DateTimeField()
    vc_usuarioCrea = models.CharField(db_column='vc_usuarioCrea', max_length=50)  # Field name made lowercase.
...
class Materiales(models.Model):
    ...
    id_codEstado = models.ForeignKey('GeneralDetalle', db_column='id_codEstado', related_name='id_codEstado',
                                     on_delete=False)  # Field name made lowercase.
    id_codTipoGasto = models.ForeignKey('GeneralDetalle', db_column='id_codTipoGasto', related_name='id_codTipoGasto',
                                        on_delete=False)  # Field name made lowercase.
    id_codFamilia = models.ForeignKey('GeneralDetalle', db_column='id_codFamilia', related_name='id_codFamilia',
                                      on_delete=False)  # Field name made lowercase.
    ...
    vc_ipEdita = models.CharField(db_column='vc_ipEdita', max_length=20, blank=True,
                                  null=True)  # Field name made lowercase.
    id_codSituacion = models.ForeignKey('GeneralDetalle', db_column='id_codSituacion', related_name='GeneralDetalle',
                                        on_delete=False)  # Field name made lowercase.
...
class Proveedor(models.Model):
    ...
    vc_telfcontacto = models.CharField(db_column='vc_telfContacto', max_length=10, blank=True,
                                       null=True)  # Field name made lowercase.
    vc_telfempresa = models.CharField(db_column='vc_telfEmpresa', max_length=10, blank=True,
                                      null=True)  # Field name made lowercase.
    b_flaginactivo = models.TextField(db_column='b_flagInactivo', blank=True,
                                      null=True)  # Field name made lowercase. This field type is a guess.
    dt_crea = models.DateTimeField()
...
class Ubigeo(models.Model):
    ...
    nu_totalprov = models.DecimalField(db_column='nu_totalProv', max_digits=3, decimal_places=0, blank=True,
                                       null=True)  # Field name made lowercase.
    nu_totaldist = models.DecimalField(db_column='nu_totalDist', max_digits=3, decimal_places=0, blank=True,
                                       null=True)  # Field name made lowercase.
    vc_descregion = models.CharField(db_column='vc_descRegion', max_length=50, blank=True,
                                     null=True)  # Field name made lowercase.
    vc_codestado = models.CharField(db_column='vc_codEstado', max_length=3)  # Field name made lowercase.
    b_flaginactivo = models.TextField(db_column='b_flagInactivo', blank=True,
                                      null=True)  # Field name made lowercase. This field type is a guess.
...
class UnidadMedida(models.Model):
    ...
    vc_codtipounidadmedida = models.CharField(db_column='vc_codTipoUnidadMedida',
