...
class Materiales(models.Model):
    ...
    nu_stockMinimo = models.DecimalField(db_column='nu_stockMinimo', max_digits=9, decimal_places=2, blank=True,
                                         null=True)  # Field name made lowercase.
    nu_stockMaximo = models.DecimalField(db_column='nu_stockMaximo', max_digits=9, decimal_places=2, blank=True,
                                         null=True)  # Field name made lowercase.    b_flagInactivo = models.BooleanField(db_column='b_flagInactivo')  # Field name made lowercase. This field type is a guess.
    ...
    vc_numNotificacion = models.CharField(db_column='vc_numNotificacion', max_length=10, blank=True,
                                          null=True)  # Field name made lowercase.
    vc_observacionDesaprobar = models.CharField(db_column='vc_observacionDesaprobar', max_length=200, blank=True,
                                                null=True)  # Field name made lowercase.
