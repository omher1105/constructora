...
class Materiales(models.Model):
    ...
    id_codEstado = models.ForeignKey('GeneralDetalle', db_column='id_codEstado', related_name='id_codEstado')  # Field name made lowercase.
    id_codTipoGasto = models.ForeignKey('GeneralDetalle', db_column='id_codTipoGasto', related_name='id_codTipoGasto')  # Field name made lowercase.
    id_codFamilia = models.ForeignKey('GeneralDetalle', db_column='id_codFamilia', related_name='id_codFamilia')  # Field name made lowercase.
    id_codClasificacion = models.ForeignKey('GeneralDetalle', db_column='id_codClasificacion', blank=True, null=True , related_name='id_codClasificacion')  # Field name made lowercase.
    vc_descripcion = models.CharField(max_length=200)
    id_codColor = models.ForeignKey('GeneralDetalle', db_column='id_codColor', blank=True, null=True,  related_name='id_codColor')  # Field name made lowercase.
    ...
    vc_usuarioEdita = models.CharField(db_column='vc_usuarioEdita', max_length=50, blank=True, null=True)  # Field name made lowercase.
    vc_ipEdita = models.CharField(db_column='vc_ipEdita', max_length=20, blank=True, null=True)  # Field name made lowercase.
    id_codSituacion = models.ForeignKey('GeneralDetalle', db_column='id_codSituacion', related_name='id_codSituacion')  # Field name made lowercase.
