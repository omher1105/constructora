...
class Clientes(models.Model):
    ...
    vc_codtipodocumento = models.ForeignKey('GeneralDetalle', db_column='vc_codTipoDocumento')  # Field name made lowercase.
    ...
    id_ubigeo = models.ForeignKey('Ubigeo', db_column='id_ubigeo', blank=True, null=True)
...
class ColaboradoresCargo(models.Model):
    ...
    id_colaborador = models.ForeignKey(Colaborador, db_column='id_colaborador')
    vc_codcargo = models.ForeignKey('GeneralDetalle', db_column='vc_codCargo')  # Field name made lowercase.
    b_flaginactivo = models.TextField(db_column='b_flagInactivo', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    dt_crea = models.DateTimeField()
    vc_usuariocrea = models.CharField(db_column='vc_usuarioCrea', max_length=50)  # Field name made lowercase.
    vc_ipcrea = models.CharField(db_column='vc_ipCrea', max_length=20)  # Field name made lowercase.
...
class GeneralDetalle(models.Model):
    ...
    id_general = models.ForeignKey(General, db_column='id_general')
...
class IngresoCabecera(models.Model):
    ...
    vc_codrepcion = models.ForeignKey(GeneralDetalle, db_column='vc_codRepcion')  # Field name made lowercase.
    id_proyecto = models.ForeignKey('Proyectos', db_column='id_proyecto')
    vc_codestado = models.ForeignKey(GeneralDetalle, db_column='vc_codEstado')  # Field name made lowercase.
    dt_emision = models.DateField()
    id_proveedor = models.ForeignKey('Proveedor', db_column='id_proveedor')
    vc_codtipocomprobante = models.ForeignKey(GeneralDetalle, db_column='vc_codTipoComprobante')  # Field name made lowercase.
    ...
    vc_codcondicionpago = models.ForeignKey(GeneralDetalle, db_column='vc_codCondicionPago')  # Field name made lowercase.
...
class Materiales(models.Model):
    ...
    id_codestado = models.ForeignKey(GeneralDetalle, db_column='id_codEstado')  # Field name made lowercase.
    id_codtipogasto = models.ForeignKey(GeneralDetalle, db_column='id_codTipoGasto')  # Field name made lowercase.
    id_codfamilia = models.ForeignKey(GeneralDetalle, db_column='id_codFamilia')  # Field name made lowercase.
    id_codclasificacion = models.ForeignKey(GeneralDetalle, db_column='id_codClasificacion', blank=True, null=True)  # Field name made lowercase.
    vc_descripcion = models.CharField(max_length=200)
    id_codcolor = models.ForeignKey(GeneralDetalle, db_column='id_codColor', blank=True, null=True)  # Field name made lowercase.
    id_unidadmedida = models.ForeignKey('UnidadMedida', db_column='id_unidadMedida')  # Field name made lowercase.
    ...
    vc_usuarioedita = models.CharField(db_column='vc_usuarioEdita', max_length=50, blank=True, null=True)  # Field name made lowercase.
    vc_ipedita = models.CharField(db_column='vc_ipEdita', max_length=20, blank=True, null=True)  # Field name made lowercase.
    id_codsituacion = models.ForeignKey(GeneralDetalle, db_column='id_codSituacion')  # Field name made lowercase.
...
class Proyectos(models.Model):
    ...
    id_colaborador = models.ForeignKey(Colaborador, db_column='id_colaborador', blank=True, null=True)
    ...
    vc_usuarioedita = models.CharField(db_column='vc_usuarioEdita', max_length=50, blank=True, null=True)  # Field name made lowercase.
    vc_ipedita = models.CharField(db_column='vc_ipEdita', max_length=20, blank=True, null=True)  # Field name made lowercase.
    vc_codestado = models.ForeignKey(GeneralDetalle, db_column='vc_codEstado', blank=True, null=True)  # Field name made lowercase.
    id_cliente = models.ForeignKey(Clientes, db_column='id_cliente')
